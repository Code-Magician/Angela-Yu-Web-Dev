...
app.post("/submit", (req, res) => {
	...
	var adjRandIdx = Math.floor(Math.random() * adj.length);
	const adjStr = adj[adjRandIdx];

	var nounRandIdx = Math.floor(Math.random() * noun.length);
	const nounStr = noun[nounRandIdx];

	const bandNameStr = `${adjStr} ${nounStr}`;
